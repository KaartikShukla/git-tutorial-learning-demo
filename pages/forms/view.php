...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container">
            <div class="container-fluid bg-primary text-white text-center rounded"style=" margin-bottom:30px;"!important><h1 style="font-size: 50px;">View User</h1>
            </div>
            <div>
                <table class="table-striped text-center" style="width:100%";>
                    ...
                    {
                        $sql="SELECT * FROM  registrationpage";
                        ...
                        <td><a href="update.php?id=<?php echo $fetch['id'];?>"><button class="btn btn-warning">Update</button></td>
                        <td><a href="delete.php?id=<?php echo $fetch['id'];?>" onclick="return confirm('Are you sure?')"><button class="btn btn-danger">Delete</button></td>
                        </tr><?php
                        }
                    }
                    else
