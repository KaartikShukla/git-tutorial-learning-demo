...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container">
            <div class="container-fluid bg-primary text-white text-center rounded"style=" margin-bottom:30px;"!important><h1 style="font-size: 50px;">View Products</h1>
            </div>
                ...
                <table class="table-striped text-center" style="width:100%";>
                    ...
                    if(isset($_SESSION['level']))
                    {
                        ...
                        <td><?php if($fetch['productstatus']==1){?>
                          <a href="?type=status&operation=deactive&id=<?php echo $fetch['productid'];?>"><button class="btn btn-success">Active</button>
                        <?php }
                        else{ ?><a href="?type=status&operation=active&id=<?php echo $fetch['productid'];?>"><button class="btn btn-warning">Deactive</button> <?php } ?> </td>
