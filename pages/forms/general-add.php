        ...
        $f_email=filter_var($email,FILTER_SANITIZE_EMAIL);
            ...
            $count_row=mysqli_num_rows($checkEmailexists_query);
                ...
                else
                {
                    if($ipass===$cpass)
                    {
                        $insert="INSERT INTO registrationpage (fullname, email, password, retypepassword, checkbox, level) VALUES ('$fname','$f_email','$nipass','$ripass','$checkbox','$level')";
                        $insert_query=mysqli_query($con,$insert);
                            if($insert_query)
                            {
                                ?><script>alert("You added user Successfully");</script><?php header("location:general-add.php"); 
                            }
                            else
                            {
...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../forms/general-add.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add User</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../forms/view.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View User</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="../forms/delete.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Delete User</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container" style="width:90%;  margin-top: 5px;"!important>
            <div class="container-fluid bg-primary text-white text-center rounded" style="margin-bottom:10px;"!important ><h1 style="font-size: 50px;">Add User</h1>
            </div>
                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="POST">
                    <div class="form-group">
                        <label class="small mb-1" for="inputFirstName">Full Name</label>
                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Enter first name" name="fullname"/>
                    </div>                   
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="small mb-1" for="inputConfirmPassword">Retype Password</label>
                        <input class="form-control py-4" id="inputConfirmPassword" type="password" placeholder="Retype password" name="retypepassword" />
                    </div>
                    <input id="inputUser" type="hidden" name="level" value="Admin"/>
                                  <input type="hidden"  name="terms" value="Agree"/>
                    <div class="form-row"><div style="margin-left:20rem; margin-right:100px;"><button type="submit" class="btn btn-primary btn-block"  name="add">ADD</button></div><div ><button type="back" class="btn btn-primary btn-block"  name="back">BACK</button></div>
                </form>
                </div>
                </section>  
                </div>   
