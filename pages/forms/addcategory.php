...
if(isset($_POST['add']))
{
  ...
  {
    $first_error="Category Name is required";
  }
  else
  {
    ...
    {
      $insert_sql="INSERT INTO category (categoryname,categorystatus) VALUES ('$categoryname','$categorystatus')";
      $insert_sql_query=mysqli_query($con,$insert_sql);
      if($insert_sql_query)
      {
      ...
      <div class="container" style="width:50%; min-height:400px; max-height:600px; position: relative;"!important>
          ...
          <form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="POST">
                    <div class="form-group">
                        ...
                        <input class="form-control py-3" style="border-radius:20px; padding-left: 30px;" id="inputFirstName" type="text" placeholder="Enter Category name" name="categoryname" value="<?php echo $category_name;?>"/></div>
                    </div>                  
