...
if(isset($_GET['type']) && $_GET['type']!='')
{
  ...
  if($type='status')
  {
    ...
    $update_status="UPDATE category SET categorystatus='$status' WHERE categoryid='$id'";
            ...
            <div>
                <table class="table-striped text-center" style="width:100%";>
                    ...
                    if(isset($_SESSION['level']))
                    {
                        ...
                        <td><?php if($fetch['categorystatus']==1){?>
                          <a href="?type=status&operation=deactive&id=<?php echo $fetch['categoryid'];?>"><button class="btn btn-success">Active</button>
                        <?php }
                        else{ ?><a href="?type=status&operation=active&id=<?php echo $fetch['categoryid'];?>"><button class="btn btn-warning">Deactive</button> <?php } ?> </td>
                        <td><a href="updatecategory.php?id=<?php echo $fetch['categoryid'];?>"><button class="btn btn-primary">Update</button></td>
                        <td><a href="deletecategory.php?id=<?php echo $fetch['categoryid'];?>" onclick="return confirm('Are you sure?')"><button class="btn btn-danger">Delete</button></td>
                        </tr><?php
                        }
                    }
                    else
